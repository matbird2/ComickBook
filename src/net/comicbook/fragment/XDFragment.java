...
public class XDFragment extends BaseFragment implements
	...
	private void loadData(int record) {
		if (getMyActivity().hasNetWork()) {
			...
			String result = getMyActivity().getCacheStr("XDFragment" + currentPagte);
	...
	public void getResult(String result) {
		getMyActivity().setCacheStr("XDFragment" + currentPagte, result);
		if (isRefresh) {
			isRefresh = false;
			cbAdapter.clear();
			listsModles.clear();
