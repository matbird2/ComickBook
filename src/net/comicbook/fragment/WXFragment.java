...
public class WXFragment extends BaseFragment implements
	...
	private void loadData(int record) {
		if (getMyActivity().hasNetWork()) {
			...
			String result = getMyActivity().getCacheStr("WXFragment" + currentPagte);
	...
	public void getResult(String result) {
		getMyActivity().setCacheStr("WXFragment" + currentPagte, result);
		if (isRefresh) {
			isRefresh = false;
			cbAdapter.clear();
			listsModles.clear();
