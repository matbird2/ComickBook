...
public class WGFragment extends BaseFragment implements
	...
	private void loadData(int record) {
		if (getMyActivity().hasNetWork()) {
			...
			String result = getMyActivity().getCacheStr("WGFragment" + currentPagte);
	...
	public void getResult(String result) {
		getMyActivity().setCacheStr("WGFragment" + currentPagte, result);
		if (isRefresh) {
			isRefresh = false;
			cbAdapter.clear();
			listsModles.clear();
