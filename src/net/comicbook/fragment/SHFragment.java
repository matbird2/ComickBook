...
public class SHFragment extends BaseFragment implements
	...
	private void loadData(int record) {
		if (getMyActivity().hasNetWork()) {
			...
			String result = getMyActivity().getCacheStr("SHFragment" + currentPagte);
	...
	public void getResult(String result) {
		getMyActivity().setCacheStr("SHFragment" + currentPagte, result);
		if (isRefresh) {
			isRefresh = false;
			cbAdapter.clear();
			listsModles.clear();
