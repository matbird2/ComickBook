...
public class GMFragment extends BaseFragment implements
	...
	private void loadData(int record) {
		if (getMyActivity().hasNetWork()) {
			...
			String result = getMyActivity().getCacheStr("GMFragment" + currentPagte);
	...
	public void getResult(String result) {
		getMyActivity().setCacheStr("GMFragment" + currentPagte, result);
		if (isRefresh) {
			isRefresh = false;
			cbAdapter.clear();
			listsModles.clear();
